...
$_['help_tax_default']             = 'Use the store address to calculate taxes if customer is not logged in. You can choose to use the store address for the customer&rsquo;s shipping or payment address.';
...
$_['help_account']                 = 'Contraindre à accepter les termes et conditions avant qu&rsquo;un compte ne soit créé.';
...
$_['help_checkout']                = 'Contraindre les clients à accepter les termes et conditions avant qu&rsquo;un client puisse commander.';
...
$_['help_icon']                    = 'L&rsquo;icône doit être un fichier PNG ayant pour dimension de 16px × 16px.';
