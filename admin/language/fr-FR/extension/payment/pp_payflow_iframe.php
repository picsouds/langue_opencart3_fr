...
$_['text_confirm_void']      = 'Si vous annulez, vous ne pourrez plus réceptionner d&rsquo;autres fonds';
...
$_['help_checkout_method']   = 'Veuillez utiliser la méthode Redirection si n&rsquo;avez pas de certificat SSL installé ou si vous n&rsquo;avez pas désactivé l&rsquo;option payer avec PayPal dans votre page de paiement hébergée.';
...
$_['entry_canceled_reversal_status'] = 'Statut Annulé';
...
$_['entry_cancel_url']               = 'Adresse URL d&rsquo;annulation : ';
$_['entry_error_url']                = 'Adresse URL d&rsquo;erreurs : ';
$_['entry_return_url']               = 'Adresse URL de retour : ';
$_['entry_post_url']                 = 'Adresse URL Silent POST : ';

// Help
$_['help_vendor']   = 'L&rsquo;ID de connexion que vous avez créé lors de votre inscription à Website Payments Pro';
$_['help_user']     = 'Si vous configurez un ou plusieurs utilisateurs supplémentaires sur le compte, cette valeur correspond à l&rsquo;ID utilisateur autorisé à traiter les transactions. Si, toutefois, vous n&rsquo;avez pas défini des utilisateurs supplémentaires sur le compte, UTILISATEUR a la même valeur que FOURNISSEUR';
$_['help_password'] = 'Le mot de passe de 6 à 32 caractères que vous avez défini lors de l&rsquo;inscription au compte PayPal';
$_['help_partner']  = 'L&rsquo;ID fourni par le revendeur agréé de PayPal qui vous a inscrit au SDK Payflow. Si vous avez acheté votre compte directement chez PayPal, utilisez l&rsquo;ID PayPal Pro à la place';
...
$_['error_general']       = 'Une erreur s&rsquo;est produite';
