...
$_['text_desc3'] 				= 'Vous pouvez lier des objets manuellement en entrant la référence (SKU) d&rsquo;Amazon et le nom du produit, ou charger tous les produits non liés, puis ajouter les références (SKU) d&rsquo;Amazon ensuite. (Charger des produits depuis OpenCart vers Amazon créera automatiquement les liaisons)';
...
$_['error_no_product_exists'] = 'Ce produit n&rsquo;existe pas. Veuillez utiliser les valeurs suggérés par la saisie semi-automatique.';
